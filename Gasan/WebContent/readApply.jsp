			...
			<div class="row">
				...
				<div class="total">
					<div class="applyview">
						...
						<div class="applyform">
							<p>
								<u:pre var="title" value="${foodApply.title }"/>
								제목&nbsp; : &nbsp; <input type="text" style="border: none;" class="title" name="title"
									value="${title }" readonly="readonly"><br>
							</p>

							<p>
								내용 <br>
								<textarea style="border: none; resize: none;" rows="13" cols="100" class="content" name="content"
									readonly="readonly">${foodApply.content}</textarea>
								<!--value가 아니라 사이에 값을 넣어야함. -->
							</p>
							<a href="listApply?pageNo=${param.pageNo }"><input type="button" value="목록" style="font-size: 20px;"></a>
							
							<c:if test="${authUser.loginId == foodApply.loginId}">
								<a class="modify" href="modifyApply?no=${foodApply.applyId }&pageNo=${param.pageNo }"><input type="button" value="수정" style="font-size: 20px;"></a>
								<a class="delete" href="deleteApply?no=${foodApply.applyId }&pageNo=${param.pageNo }"><input type="button" value="삭제" style="font-size: 20px;"></a>
							</c:if>
						</div>
