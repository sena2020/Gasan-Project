			...
			<div class="row">
				...
				<div class="total">
					<div class="applyview">
						...
						<div class="applyform">
						<form action="modifyApply" method="post">
						<input type="hidden" name="no" value="${foodApply.applyId }" >
							<u:pre value="${foodApply.title }" var="title"/>
							<p>
							...
							<p>
								내용 <br>
								<textarea rows="13" cols="100" class="content" name="content" style="resize: none;">${foodApply.content }</textarea>
